...
{
    public static function add($lc_request_id,$user_id,$status_id,$created_at,$reason_code = null,$amendment_request_id = null,$amendment_request_status_id = null,$comments = null){
