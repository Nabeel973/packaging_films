...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" class="btn btn-primary" onclick="submitResetPassword()">Reset
                        Password</button>
                </div>
            </div>
            <!-- /.modal-content -->
    ...
    <style>
        ...
        .left {
            flex: 80%;
            /* Set left paragraph to take 70% of container */
            margin: 0;
        ...
        .right {
            flex: 20%;
            /* Set right paragraph to take 30% of container */
            margin-left: 10px;
