...
@section('content-header')
    <h1>Add New Shipment Clearance Request</h1>
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="quickForm" method="post" action="{{ route('clearance_request.submit',$id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-2">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="shipment_type form-control" id="shipment_type_id" name="shipment_type_id">
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="tax" class="form-control " id="tax"
                                placeholder="Enter Duties and Taxes (Estd)">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group shipment_date" id="shipmentdatepicker" data-target-input="nearest">
                                <input type="text" class="form-control shipment-datetimepicker-input"
                                    data-target="#shipmentdatepicker" id="shipment_date" name="shipment_date">
                ...
                <div class="row justify-content-center mt-2">
                    ...
                    <button type="submit" class="btn btn-warning btn-lg mx-2" id="submit-button">
                      <i class="fas fa-save pr-2"> </i> Submit Shipment Planning
                    </button>
