  ...
  $(document).ready(function() {
    ...
    var table = $("#example1").DataTable({
     ...
     "buttons": [
      ...
      "ajax": {
        url: "{{ route('clearance_request.logs') }}",
        "type": "GET",
        data: function (d) {
      ...
      columns: [
          { data: "id" },
          { data: "clearance_id",searchable: true },
      ...
      "pageLength": 10, // Set default number of records per page
        ...
        responsive: true, 
        autoWidth: false,
        order: [[4, 'desc']],  // Set default sort order on the "priority" column (index 8)
