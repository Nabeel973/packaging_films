      ...
      <div class="card">
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              <th>ID</th>
              <th>Import Request ID</th>
              <th>Import Request Status</th>
              <th>Reason</th>
              <th>Comments</th>
              <th>Created By</th>
              <th>Created At</th>
  ...
  $(document).ready(function() {
    ...
    var table = $("#example1").DataTable({
     ...
     "buttons": [
      ...
      columns: [
          { data: "id" },
          { data: "import_requests_id",searchable: true },
      ...
      "pageLength": 10, // Set default number of records per page
        ...
        responsive: true, 
        autoWidth: false,
        order: [[6, 'desc']],  // Set default sort order on the "priority" column (index 8)
